...
function ale_enqueue_styles() {
	...
	wp_register_style( 'main_css', THEME_URL . '/css/style.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'fonts_css', THEME_URL . '/css/fonts.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'owl_css', THEME_URL . '/css/owl.carousel.css', array(), ALETHEME_THEME_VERSION, 'all');
	// not load style.css for 404 page
    if (!is_404()){
